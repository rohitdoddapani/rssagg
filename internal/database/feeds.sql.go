...
RETURNING id, created_at, updated_at, user_id, title, url, description, image_url, last_updated, last_fetched_at
`
...
SELECT id, created_at, updated_at, user_id, title, url, description, image_url, last_updated, last_fetched_at FROM feeds
`
